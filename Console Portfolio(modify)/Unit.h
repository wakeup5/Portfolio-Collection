...
public:
	...
	void addExp(int exp){ _exp += exp; if (_exp > _level * 150) { _exp -= _level * 150; levelUp(); } }
...
public:
	...
	void setFund(int fund){ _fund = fund; }
	int getFund(){ return _fund; }

	Item* getHelmet(){ return _helmet; }
	void setHelmet(Item* item){ _helmet = item; }
	Item* getTop(){ return _top; }
	void setTop(Item* item){ _top = item; }
	Item* getPants(){ return _pants; }
	void setPants(Item* item){ _pants = item; }
	Item* getShoes(){ return _shoes; }
	void setShoes(Item* item){ _shoes = item; }
	Item* getGlove(){ return _glove; }
	void setGlove(Item* item){ _glove = item; }
	Item* getWeapon(){ return _weapon; }
	void setWeapon(Item* item){ _weapon = item; }
	Item* getEquipItem(ITEM_TYPE type);
	void setEquipItem(Item*);
